...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   reflected_xss_3.cy.js                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: sazzeddi <sazzeddi@student.42berlin.de>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/26 13:37:48 by sazzeddi          #+#    #+#             */
/*   Updated: 2023/07/26 13:40:08 by sazzeddi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
describe('Reflected XSS Test', () => {
  it('should execute a Reflected XSS payload', () => {
    const payload = '"><script>alert("OPS!! another third one !!");</script>';
    const vulnerableURL = 'https://app-web-berlin42-50e7ace7d4d7.herokuapp.com/reflected_xss_3';
